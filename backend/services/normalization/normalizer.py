...
def normalize_razorpay_event(
    ...
    elif event_str in ["subscription.halted", "subscription.pending"]:
    ...
    event_id = raw_payload.get("event_id") or raw_payload.get("id") or payment_entity.get("id") or f"evt_{int(datetime.now(timezone.utc).timestamp())}"
    ...
    error_code = payment_entity.get("error_code") or raw_payload.get("error_code")
    error_desc = payment_entity.get("error_description") or raw_payload.get("error_description") or payment_entity.get("error_reason")
