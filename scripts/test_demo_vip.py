...
print(f"Attempts: {previous_attempts} (VIP) | ML Action: {predictions.best_candidate_action.value} | Agent Action: {proposal.selected_action.value} | Reasoning: {proposal.reasoning}")
